...
For the fisher exact test shows if you get the vaccine you are 0.35 times likey to get aids.
The chisq test has a p-value 0.0000001242 and I reject the null hypothesis because it is so small proving there is relationship between getting the vaccine and not receieving aids
.
...
Rejecting the null hypothesis because the drug is more effective in preventing aids than the placebo.